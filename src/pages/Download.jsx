...
import { trackDownload } from "../utils/analytics.js";
...
export default function Download() {
  ...
  useEffect(() => {
    fetch("/downloads/latest.json")
      .then((response) => {
        if (!response.ok) {
          throw new Error("Failed to load download information");
        }
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <section className="mx-auto max-w-4xl text-center">
          ...
          <p
            ...
            "
          >
            Download PicoDesk for Windows and experience fast, secure and
            reliable remote desktop access built for everyone.
          </p>
        </section>
        ...
        <section className="mx-auto mt-16 max-w-3xl">
          ...
          >
            ...
            <p
              ...
              "
            >
              Download the installer, complete the setup, and start connecting
              to remote devices in minutes.
            </p>
          </div>
        </section>
      </div>
