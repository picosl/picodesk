...
const features = [
  [ShieldCheck, 'Enterprise Security', 'End-to-end encryption and a zero-trust connection model protect every session.'],
  [Zap, 'Ultra-Low Latency', 'A fast connection experience that feels smooth and responsive.'],
  [Globe2, 'Global Access', 'Connect to your computers securely from anywhere in the world.'],
  [MonitorSmartphone, 'Cross-Device Access', 'Use PicoDesk across supported desktop and mobile devices.'],
  [Users, 'Team Management', 'Organize users, devices and access permissions from one place.'],
  [Gauge, 'High Performance', 'Enjoy clear remote video with efficient hardware acceleration.'],
];
...
export default function Home() {
  ...
  <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col items-center px-6 text-center lg:px-8">
    ...
    <p className="mt-8 max-w-3xl text-lg leading-8 text-slate-400 md:text-xl">
      ...
      lightning-fast performance, end-to-end encryption, and an
      intuitive remote desktop experience for individuals and businesses.
    </p>
  ...
  <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <div className="mx-auto mb-20 max-w-3xl text-center">
      ...
      <p className="mt-6 text-lg leading-8 text-slate-400">
        ...
        Powerful features engineered to deliver secure,
        lightning-fast and reliable remote desktop
        experiences for professionals, businesses
        and everyday users.
    ...
    <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-3">
      ...
      {features.map(([Icon, title, description]) => (
        ...
        >
          ...
          <div className="absolute left-0 top-0 h-1 w-full bg-gradient-to-r from-blue-600 to-cyan-400 scale-x-0 origin-left transition-transform duration-500 group-hover:scale-x-100" />
  ...
  <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <div className="overflow-hidden rounded-[36px] border border-slate-800 bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 px-8 py-20 text-center shadow-[0_30px_80px_rgba(0,0,0,.45)] md:px-20">
      ...
      <p className="mx-auto mt-8 max-w-3xl text-xl leading-9 text-slate-400">
        ...
        Whether you're working remotely, providing IT support,
        or managing business infrastructure, PicoDesk gives you
        secure remote access with enterprise-grade performance.
